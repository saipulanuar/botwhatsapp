...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6288279268363@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Bilang Bear Ganteng',
			error: {
        ...
        let zero = fs.readFileSync ('./zeroyt7/bear2.jpg')
                ...
                quoted: {
                    ...
                    message: {
                        "imageMessage": {
                            ...
                            "jpegThumbnail": fs.readFileSync('./zeroyt7/bear3.jpg'),
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Bear Ganteng Banget`, 
                            orderTitle: `Bear Ganteng Banget`,
...
switch (command) {
	case 'menu':
	gambar = fs.readFileSync('./zeroyt7/bear3.jpg')
                   timestamp = speed();
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : Bear', but, mek)
break
...
costum(buffer, sticker, Verived, `Jangan Lupa Bilang Bear Ganteng`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Bilang Bear Ganteng`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Bilang Bear Ganteng' })
fs.unlinkSync(ran)
})
break
...
zeroyt7.sendMessage(`6288279268363@s.whatsapp.net`, options, text, { quoted: ftrol })
